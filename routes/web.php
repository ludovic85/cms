...
use App\Http\Controllers\Admin\EtablissementDeCreditsController as EtablissementDeCreditsControllerForAdmin;
use App\Http\Controllers\Admin\IndemnisationsController as IndemnisationsControllerForAdmin;
use App\Http\Controllers\Admin\ContributionsController as ContributionsControllerForAdmin;
...
use App\Http\Controllers\Admin\PageBanqueController;
use App\Http\Controllers\Admin\PageBaseDocController;
...
use App\Http\Controllers\Admin\PageCurativeController;
use App\Http\Controllers\Admin\PageFaqController;
use App\Http\Controllers\Admin\PageHomeController;
use App\Http\Controllers\Admin\PageMissionsController;
use App\Http\Controllers\Admin\PageOrganisationController;
use App\Http\Controllers\Admin\PageOtherController;
use App\Http\Controllers\Admin\PagePhotoGalleryController;
use App\Http\Controllers\Admin\PagePresentationController;
use App\Http\Controllers\Admin\PagePreventiveController;
use App\Http\Controllers\Admin\PagePrivacyController;
use App\Http\Controllers\Admin\PageProcessusController;
...
use App\Http\Controllers\Admin\BankIndemController;
...
use App\Models\Front\AboutController;
use App\Models\Front\ActualitesController;
use App\Models\Front\BanqueController;
use App\Models\Front\BaseDocController;
use App\Models\Front\BlogController as BlogControllerForFront;
use App\Models\Front\CategoryController as CategoryControllerForFront;
use App\Models\Front\ContactController;
use App\Models\Front\CurativeController;
use App\Models\Front\FaqController as FaqControllerForFront;
use App\Models\Front\HomeController;
use App\Models\Front\JobController as JobControllerForFront;
use App\Models\Front\MecanismeController;
use App\Models\Front\MissionsController;
use App\Models\Front\OrganisationController;
use App\Models\Front\PageController;
use App\Models\Front\PhotoGalleryController;
use App\Models\Front\PresentationController;
use App\Models\Front\PreventiveController;
use App\Models\Front\PrivacyController;
use App\Models\Front\ProcessusController;
use App\Models\Front\ProductController as ProductControllerForFront;
use App\Models\Front\ProjectController as ProjectControllerForFront;
use App\Models\Front\SearchController;
use App\Models\Front\ServiceController as ServiceControllerForFront;
use App\Models\Front\SubscriptionController;
use App\Models\Front\TeamMemberController as TeamMemberControllerForFront;
use App\Models\Front\TermController;
use App\Models\Front\TraitIndemController;
use App\Models\Front\BasedocumentaireController;
use App\Models\Front\VideoGalleryController;
...
Route::get('/', [HomeController::class,'index'])->name('banque.index');;
...
Route::get('presentation', [PresentationController::class,'index'])->name('front.presentation');
Route::get('organisation', [OrganisationController::class,'index'])->name('front.organisation');
Route::get('missions', [MissionsController::class,'index'])->name('front.missions');
Route::get('preventive', [PreventiveController::class,'index'])->name('front.preventive');
Route::get('curative', [CurativeController::class,'index'])->name('front.curative');
Route::get('processus', [ProcessusController::class,'index'])->name('front.processus');
Route::get('base_doc',[BaseDocController::class,'index'])->name('front.base_doc');
Route::get('trait_indem',[TraitIndemController::class,'index'])->name('front.trait_indem');
Route::get('document',[DocumentController::class,'index'])->name('front.document');
Route::get('indemnisation',[IndemnisationController::class,'index'])->name('front.indemnisation');
Route::get('banque',[BanqueController::class,'index'])->name('front.banque');
Route::get('actualites',[ActualitesController::class,'index'])->name('front.actualites');
Route::get('mecanisme',[MecanismeController::class,'index'])->name('front.mecanisme');
Route::get('basedocumentaire',[BasedocumentaireController::class,'index'])->name('front.basedocumentaire');
...
Route::group(['prefix'=>'admin/page'], function() {
    ...
    Route::get('/presentation/edit', [PagePresentationController::class,'edit'])->name('admin.page_presentation.edit');
    Route::post('/presentation/update', [PagePresentationController::class,'update']);

    Route::get('/organisation/edit', [PageOrganisationController::class,'edit'])->name('admin.page_organisation.edit');
    Route::post('/organisation/update', [PageOrganisationController::class,'update']);

    Route::get('/missions/edit', [PageMissionsController::class,'edit'])->name('admin.page_missions.edit');
    Route::post('/missions/update', [PageMissionsController::class,'update']);

    Route::get('/preventive/edit', [PagePreventiveController::class,'edit'])->name('admin.page_preventive.edit');
    Route::post('/preventive/update', [PagePreventiveController::class,'update']);

    Route::get('/curative/edit', [PageCurativeController::class,'edit'])->name('admin.page_curative.edit');
    Route::post('/curative/update', [PageCurativeController::class,'update']);

    Route::get('/processus/edit', [PageProcessusController::class,'edit'])->name('admin.page_processus.edit');
    Route::post('/processus/update', [PageProcessusController::class,'update']);

    Route::get('/base_doc/edit', [PageBaseDocController::class,'edit'])->name('admin.page_base_doc.edit');
    Route::post('/base_doc/update', [PageBaseDocController::class,'update']);

    Route::get('/trait_indem/edit', [PageTraitIndemController::class,'edit'])->name('admin.page_trait_indem.edit');
    Route::post('/trait_indem/update', [PageTraitIndemController::class,'update']);

    Route::get('/banque/edit', [PageBanqueController::class,'edit'])->name('admin.page_banque.edit');
    Route::post('/banque/update', [PageBanqueController::class,'update']);
...
/* --------------------------------------- */
/* Etablissement de credits - Admin */
/* --------------------------------------- */
Route::get('admin/etablissementdecredits/view', [EtablissementDeCreditsControllerForAdmin::class,'index'])->name('admin.etablissementdecredits.index');
Route::get('admin/etablissementdecredits/create', [EtablissementDeCreditsControllerForAdmin::class,'create'])->name('admin.etablissementdecredits.create');
Route::post('admin/etablissementdecredits/store', [EtablissementDeCreditsControllerForAdmin::class,'store'])->name('admin.etablissementdecredits.store');
Route::get('admin/etablissementdecredits/delete/{id}', [EtablissementDeCreditsControllerForAdmin::class,'destroy']);
Route::get('admin/etablissementdecredits/edit/{id}', [EtablissementDeCreditsControllerForAdmin::class,'edit']);
Route::post('admin/etablissementdecredits/update/{id}', [EtablissementDeCreditsControllerForAdmin::class,'update']);
...
/* --------------------------------------- */
/* Indemnisations - Admin */
/* --------------------------------------- */

Route::get('admin/indemnisations/create', [IndemnisationsControllerForAdmin::class,'create'])->name('admin.indemnisations.create');
Route::post('admin/indemnisations/store', [IndemnisationsControllerForAdmin::class,'store'])->name('admin.indemnisations.store');
Route::get('admin/indemnisations/view', [IndemnisationsControllerForAdmin::class,'index'])->name('admin.indemnisations.index');
Route::get('admin/indemnisations/delete/{id}', [IndemnisationsControllerForAdmin::class,'destroy']);
Route::get('admin/indemnisations/edit/{id}', [IndemnisationsControllerForAdmin::class,'edit']);
Route::post('admin/indemnisations/update/{id}', [IndemnisationsControllerForAdmin::class,'update']);


Route::get('admin/contributions/view', [ContributionsControllerForAdmin::class,'index'])->name('admin.contributions.index');

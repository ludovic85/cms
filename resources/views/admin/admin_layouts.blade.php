        ...
        <li class="nav-item @if($conName[1] == 'page') active @endif">
            ...
            <div id="collapsePageSettings" class="collapse @if($conName[1] == 'page') show @endif" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item @if($conName[2] == 'presentation') active @endif" href="{{ route('admin.page_presentation.edit') }}">Présentation</a>
                    <a class="collapse-item @if($conName[2] == 'organisation') active @endif" href="{{ route('admin.page_organisation.edit') }}">Organisation</a>
                    <a class="collapse-item @if($conName[2] == 'missions') active @endif" href="{{ route('admin.page_missions.edit') }}">Missions</a>
{{--                    <a class="collapse-item @if($conName[2] == 'preventive') active @endif" href="{{ route('admin.page_preventive.edit') }}">Int. préventive</a>--}}
{{--                    <a class="collapse-item @if($conName[2] == 'curative') active @endif" href="{{ route('admin.page_curative.edit') }}">Int. curative</a>--}}
                    <a class="collapse-item @if($conName[2] == 'processus') active @endif" href="{{ route('admin.page_processus.edit') }}">Processus</a>
                    <a class="collapse-item @if($conName[2] == 'base_doc') active @endif" href="{{ route('admin.page_base_doc.edit') }}">Base doc</a>
{{--                    <a class="collapse-item @if($conName[2] == 'trait_indem') active @endif" href="{{ route('admin.page_trait_indem.edit') }}">Trait. indemn</a>--}}
{{--                    <a class="collapse-item @if($conName[2] == 'banque') active @endif" href="{{ route('admin.page_banque.edit') }}">Trait. indemn</a>--}}
        ...
        <!-- Indemnisations Section -->
            @php if( in_array('Trait Indemnisations Section', $arr_one) || session('role_id')==1 ): @endphp
            <li class="nav-item @if($conName[1] == 'tab indemnisations' || $conName[1] == 'contributions') active @endif">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTraitIndemnisations" aria-expanded="true" aria-controls="collapseTraitIndemnisations">
                    <i class="fas fa-folder-plus"></i>
                    <span>Trait. Indemnisations</span>
                </a>
                <div id="collapseTraitIndemnisations" class="collapse @if($conName[1] == 'tab indemnisations' || $conName[1] == 'contributions') show @endif" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('admin.indemnisations.index') }}">Panel Indemnisations</a>
{{--                        <a class="collapse-item" href="{{ route('admin.indemnisations.index') }}">Indemnisations</a>--}}
                        <a class="collapse-item" href="{{ route('admin.contributions.index') }}">Contributions</a>
                    </div>
                </div>
            </li>
            @endif
        ...
        <!-- Etablissement de credits -->
        @php if( in_array('Etablissement de credit', $arr_one) || session('role_id')==1 ): @endphp
        <li class="nav-item @if($conName[1] == 'etablissement_de_credits') active @endif">
            <a class="nav-link" href="{{ route('admin.etablissementdecredits.index') }}">
                <i class="fas fa-building"></i>
                <span>Etablissement De Crédits</span>
            </a>
        </li>
        @endif

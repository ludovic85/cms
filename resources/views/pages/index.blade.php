    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 wow fadeInLeft">
                ...
                <p style="font-family: 'Times New Roman'; font-size: 18px; text-align: justify;">
                ...
                <div class="service-carousel owl-carousel">
                    ...
                    <div class="service-item wow fadeInUp">
                        ...
                        <div class="text">
                            ...
                            <div class="read-more">
                                <a href="{{ url('service/'.$row->slug) }}">Lire +</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
                ...
                <div class="project-carousel owl-carousel">
                    ...
                    <div class="project-item wow fadeInUp">
                        ...
                        <div class="text">
                            ...
                            <div class="read-more">
                                <a href="{{ url('project/'.$row->project_slug) }}">Lire +</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
                ...
                <div class="blog-carousel owl-carousel">
                    ...
                    <div class="blog-item wow fadeInUp">
                        ...
                        <div class="blog-text">
                            ...
                            <div class="read-more">
                                <a href="{{ url('blog/'.$row->blog_slug) }}">Lire +</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
            ...
            <div class="col-md-12 newsletter">
                ...
                <div class="newsletter-button wow fadeInUp">
                    <form action="{{ route('front.subscription') }}" method="post" class="frm_newsletter justify-content-center">
                        @csrf
                        <input type="text" placeholder="tapez Votre Email" name="subs_email">

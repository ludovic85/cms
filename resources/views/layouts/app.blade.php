...
@yield('content')
<div class="top-contact" style="background-color:#00183A;">
    <div class="container">
        <div class="row">
            <!-- <div class="col-6">
                <div class="footer-item footer-service" style="margin-top:5px;">
                <h2 style="margin-bottom: 5px;">Liens Utiles</h2>
                <ul class="fmain">
            ...
            <div class="col-12">
            <div class="footer-item footer-contact" style="margin-top:5px; text-align:center;">
                <ul>
                    <li>Libreville, GABON</li>
                    <li>info@fogadac.com</li>
                    <li>(+241) 11 76 13 73</li>
                </ul>
            </div>
            </div>
            </div>
         ...
         <div class="top-contact" style="background-color:#00183A;">
           <p style="font-size: 10px; text-align:center;"> Copyright 2022. FOGADAC. All Rights Reserved.</p>
         </div>
